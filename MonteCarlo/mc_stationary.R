# this file generates mc_output/stationary_table.tex
...
for (N in c(50)){
  ...
  for (C in c(0, -5, -10, -20, -30)){
    print(C)
    for (delta in c(-0.95, -0.75, -0.5)){
...
print(xtable(master_df[ , c("Obs","c","rho","delta","T.test","Bonf.Q.test","Q.test","Bonf.Q.test.two.sided")],
            digits=c(0,0,0,3,2,4,4,4,4), type = "latex"), file = "mc_output/stationary_table.tex")
